...
public class mapper {
    public static BookResponseDto bookToBokResponseDto(Book book) {
        BookResponseDto bookResponseDto = new BookResponseDto();
        bookResponseDto.setId(book.getId());
        bookResponseDto.setCategoryNames(book.getCategory().getName());
    ...
    public static List<BookResponseDto> booksToBookResponseDtos(List<Book> books) {
        ...
        for (Book book : books) {
            bookResponseDtos.add(bookToBokResponseDto(book));
        }
    ...
    public static List<CategoryResponseDto> categoriesToCtegoryResponseDtos(List<Category> categories) {
